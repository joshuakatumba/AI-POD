...
SECRET_KEY = 'django-insecure-48p8l^k(pur-!%%6^ners%m5y7i3q%o27gi&nr%z-gpdz5jp^$'
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(hours=24),  # optional, you can change this
}
