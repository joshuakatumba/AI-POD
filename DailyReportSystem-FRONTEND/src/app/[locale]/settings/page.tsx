...
export default function SettingsPage() {
    ...
    const tabs = [
      { label: t('tabs.profile'), desc: 'Manage your profile' },
      { label: t('tabs.preferences'), desc: 'Appearance & language' },
      { label: t('tabs.notifications'), desc: 'Email & alerts' },
      { label: t('tabs.organization'), desc: 'Team & members' },
      { label: t('tabs.ai_integrations'), desc: 'AI & services' },
    ];
