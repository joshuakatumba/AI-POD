...
class TestAddUserToOrganisation(APITestCase):
    ...
    def test_add_member_duplicate(self):
        user = User.objects.create_user(email="dup@example.com", password="pass123")
    ...
    def test_add_member_permission_denied(self):
        ...
        member_user = User.objects.create_user(email="member2@example.com", password="password123")
        payload = {"email": member_user.email}
